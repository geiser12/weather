...
FETCH_VARS = [
    ...
    "wind_direction_10m", "relative_humidity_2m", "shortwave_radiation",
    "pressure_msl",
]
...
VAR_META = {
    ...
    "wind_speed_10m":            ("Wind Speed",           "mph",  0, WIND_STOPS,      (0, 150),     1.0),
...
def add_derived(arrs, models):
    for m in models:
        ...
        spd = a["wind_speed_10m"]
        rad = np.deg2rad(a["wind_direction_10m"])
...
def make_demo_data(lats, lons, models):
    ...
    for mi, m in enumerate(models):
        ...
        d = {
            ...
            "wind_speed_10m": spd, "wind_direction_10m": wdir,
